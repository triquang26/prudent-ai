...
\textbf{Right:} on 476 ground-truth decisions with one binding axis hidden, ranking on the visible axes silently violates the hidden constraint on 57.1\% of decisions, while the selective procedure abstains and names the resolving measurement (zero violations, 95\% CI [46.8, 67.6]).}
\label{fig:teaser}
\end{figure}
